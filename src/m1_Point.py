...
class Point(object):
    ...
    def move_to(self, x, y):
        movedPoint = Point(x, y)
        self.distTraveled = self.distTraveled + self.get_distance_from(movedPoint)
    ...
    def move_by(self, x, y):
        movedPoint = Point(self.x + x, self.y + y)
        self.distTraveled = self.distTraveled + self.get_distance_from(movedPoint)
    ...
    def get_distance_from_start(self):
        xDiff = self.x - self.initialX
        yDiff = self.y - self.initialY
...
def run_test_repr():
    ...
    """
    # ------------------------------------------------------------------
    # DOEN: 4.  Follow the same instructions as in TO-DO 3 above,
